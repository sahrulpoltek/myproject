    ...
    <div id="page-inner">
		...
		<table class="table table-bordered">
			...
			<tbody>
				...
				?>
				<tr>
					<td style="text-align:center"><?php echo $vm['created']?></td>
					...
					<!-- <td style="text-align:center"><a target="_blank" href="http://<?= $vm['ip_address'].":8000"?>"><button><i class="glyphicon glyphicon-edit"></i></button></a></td> -->
				</tr>
				<?php } ?>
			</tbody>
		</table>
							...
							<div class="form-group">
								<div class="row">
									...
									<div class="col-md-12">
										...
										<input class="form-control" type="text" id="hostname" required aria-describedby="nameHelp" placeholder="hostname" name="hostname">
									</div>
								...
								<div class="row">
									...
									<div class="col-md-6">
										...
										<fieldset class="form-control">
											...
											<label style="padding-left:40px;">
												<input  type="radio" name="db" value="influxdb"> Influxdb
											</label>
										</fieldset>
									</div>
								</div>
		...
		$.ajax({
			...
			success: function (data) {
				if(JSON.parse(data)){
					...
					let show = `<iframe srcdoc="<pre>${JSON.parse(data)}" scrolling="yes" width="100%" height="500px"></iframe>`
